  ...
  return (
    <div className='pt-24'>
      ...
      <div>
        ...
        <h1 className='lg:text-4xl md:text-3xl font-semibold text-center text-sky-500 pt-10'>Upcoming Events</h1>
        ...
        <h1 className='lg:text-4xl md:text-3xl font-semibold text-center text-sky-500 pt-10'>Past Events</h1>
