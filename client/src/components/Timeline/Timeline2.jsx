...
function Timeline2() {
  ...
  return (
    <div className="timeline-container">
      <h5 className="lg:text-4xl md:text-3xl text-3xl px-5 text-center text-sky-500 pb-10 font-semibold">Glorious Past of <span className="text-white">NIT Srinagar</span></h5>
      <VerticalTimeline>
