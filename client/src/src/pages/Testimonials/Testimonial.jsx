...
const Testimonial = () => {
  ...
  return (
    <div className='pt-24 min-h-screen'>
      <Meta name={Testimonial ? Testimonial.name : "Blog - NIT Srinagar"} />
          ...
          Testimonial && <div className='m-auto pt-10 flex flex-col items-center justify-center'>
            ...
            <div className='bg-gray-800 p-5 pb-8 rounded-xl'>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className='flex md:flex-row flex-col gap-5'>
                ...
                />
                <button disabled={loading} onClick={handleSubmit(onSubmit)} className='bg-[#205781] hover:bg-black disabled:bg-gray-600 h-10 self-end px-5 py-2 mt-2 rounded-lg cursor-pointer text-white'>Submit</button>
              </form>
            </div>
          </div>
      }
