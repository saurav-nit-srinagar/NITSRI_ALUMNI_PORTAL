...
const History = () => {
    return (
        <>
            <Meta name="History" />
            <div>
                <Heading heading="History of NITSGR"></Heading>
            </div>
                        ...
                        <div className="mx-auto max-w-screen-xl text-center lg:py-16 py-10 px-6">
                            <div className="mx-auto max-w-screen-sm">
                                ...
                                <p className="lg:text-lg text-gray-300 text-justify">
                                    NIT Srinagar functions from a 40 acres (16 ha) campus
                                    along Hazratbal geographically which lies on
                                ...
                                <p className="lg:text-lg mt-5 text-gray-300 text-justify">
                                    ...
                                    village in Srinagar, around 40 km from Srinagar.

                                    Earlier it was assigned at Dumri village in Srinagar.
                                    Once NIT-Srinagar
                                    shifts to its new campus in Srinagar, it will run some
