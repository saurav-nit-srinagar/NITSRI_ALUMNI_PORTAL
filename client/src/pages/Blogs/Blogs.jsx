...
const Blogs = () => {
  ...
  const { data: blogs, isLoading, isError } = useQuery({
    queryKey: ['66d744fa003605e2b2ed', page, search],
    queryFn: () => getPaginatedPublishedDocs('66d744fa003605e2b2ed', itemsPerPage, itemsPerPage * (page - 1), "published", search, "title"),
  });
