  ...
  return (
    <div className='lg:px-9 px-4'>
      ...
      <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-5">
        <div className="text-lg font-medium">Welcome to Alumni NITSGR</div>
        <div className="flex gap-3">
          ...
          }} className="bg-[#4B164C] hover:bg-black disabled:bg-gray-600 active:bg-gray-500 text-white px-3 py-1.5 rounded-lg shadow-md hover:shadow-lg transition duration-300 ease-in-out">
